 ...
 * La sincronización utiliza dos listados. Uno que representa a los objetos que
 * se encuentran en la BD y otro que representa a los objetos de sincronización .
 *
...
public class ListOperationsDB<T, ID extends Serializable> {
    ...
    /**
     * DAO que ejecutará las operaciones en la BD.
     */
     ...
     * las operaciones.
     * @param dsa Objeto que contiene la información de auditoría de usuario.
     */
    ...
    /**
     * TODO: GLOZADA se debe verificar el método Procesa las operaciones de
     ...
     * @return número de registros que se creo, actualizo y elimino
     */
